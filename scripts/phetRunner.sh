...
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name mash_mabs -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_mash_mabs --use-conda --nolock --printshellcmds"

# MASH for Mycobacterium intracellulare
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name mash_maic -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_mash_maic --use-conda --nolock --printshellcmds"

# Hi-Cap for Haemophilus_influenzae
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name hicap -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_hicap --use-conda --nolock --printshellcmds"

# GBS for Stretococcus agalactiae
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name gbs -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_gbs --use-conda --nolock --printshellcmds"

# Choleraetyper - Abricate for Vibrio cholerae
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name choleraetyper -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_choleraetyper --use-conda --nolock --printshellcmds"

# Kleborate - for Klebsiella species 
sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name kleborate -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_kleborate --use-conda --nolock --printshellcmds"

# Sistr for Salmonella typing
sistr=$(sbatch --exclude=frgeneseq-control --nodelist=frgeneseq03 --nodes=1 --job-name sistr -o slurm-%x-%j.out --mem 50G --ntasks 16 --time 960:00:00 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 16 --configfile /scratch/phesiqcal/$folder/PHET/phet.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_sistr --use-conda --nolock --printshellcmds")
...
if [ -n "$JOBID_sistr" ]; then
    ...
    --ntasks 32 --time 960:00:00 -D /scratch/phesiqcal/$folder/ \
    --wrap "/phe/tools/sniPHEy/scripts/Snippy_runner.sh /scratch/phesiqcal/$folder/Version_record_$folder.csv"
else
