...
phesiqcal=$(sbatch --job-name phesiqcal --mem 100G --ntasks 32 --time 960:00:00 -w frgeneseq03 -D /scratch/phesiqcal/$folder/ --wrap "snakemake -j 32 --configfile /scratch/phesiqcal/$folder/config.yaml --snakefile /phe/tools/PHET/scripts/Snakefile_phesiqcal --use-conda")
