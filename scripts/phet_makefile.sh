...
# 18/03/26 - AK - Selecting NTMs and Nocardia for 16s_rpoB_hsp analysis.
awk 'BEGIN {print "16S_hsp65_rpoB:"}; (FS="\t") {if($9 ~/Myco/ && $9 !~/abscessus/ && $9 !~/tuberculosis/ && $9 !~/intracellulare/ || $9 ~/Nocardia/) print "- \"" $1 "\"" }' "$QC_FILE"